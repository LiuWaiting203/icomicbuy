...
VContainer.pa-0(fluid)
  VRow(no-gutters)
    VCol.h-100(cols="12")
      .banner-image.pa-15
        h1.text-font-size.text-shadow 給予創作者一個自由販售商品的平台
        h1.text-font-size.text-shadow 能讓消費者更容易找到喜愛的作品及作者
        h1.text-font-size.text-shadow 所有人都能輕鬆簡單上手
    VCol(cols="12")
      .product-intro
        VContainer
          VRow
            ...
            VCol(cols="6" md="6" lg="3" v-for="randomProduct in randomProducts" :key="randomProduct._id")
              ProductCard(v-bind="randomProduct" hidedetail)
    VCol.py-15.mb-15(cols="12" style="position: relative;")
      VImg.hide-img(src="@/assets/cdbox.png" width="150" style="position: absolute;")
      ...
      VImg.hide-img(src="@/assets/tablet.png" width="150" style="position: absolute; left: calc(100% - 140px);")
    VCol.mt-10(cols="12")
      VParallax(src="@/assets/parllex.jpg" height="500")
        .d-flex.flex-column.fill-height.justify-center.align-center.text-white
          p.text-center.text-h3.font-weight-bold 開始販售你的商品吧！ <br> 或是瀏覽你所喜愛的作品。
